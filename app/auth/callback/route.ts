...
export async function GET(request: NextRequest) {
  ...
  if (code) {
    ...
    if (!error && data.user) {
      ...
      // Note: Pending invitations are now shown on the dashboard
      // Users can accept or decline them manually there
      // No auto-join - user has control over which orgs they join
