...
export default function ExplorePage() {
  ...
  const fetchRecommendations = useCallback(async () => {
    ...
    try {
      ...
      console.log('🎯 [ExplorePage] ════════════════════════════════════════════════')
      console.log('🎯 [ExplorePage] 📅 Query updated_at from API:', data._debug?.queryUpdatedAt)
      console.log('🎯 [ExplorePage] 🔄 Using fresh client:', data._debug?.usingFreshClient)
      console.log('🎯 [ExplorePage] ════════════════════════════════════════════════')
      console.log('🎯 [ExplorePage] 🔴 API QUERY (from fresh DB fetch):')
